...
/** Connection between the ProductDetails_Fields type and the MediaItem type */
...
export type CreateProductCategoryInput = {
  ...
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the product_category object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the product_category object to mutate */
  name: Scalars['String']['input'];
  /** The database ID of the product_category that should be set as the parent. This field cannot be used in conjunction with parentId */
  parentDatabaseId?: InputMaybe<Scalars['Int']['input']>;
  /** The ID of the product_category that should be set as the parent. This field cannot be used in conjunction with parentDatabaseId */
  parentId?: InputMaybe<Scalars['ID']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** The Product type */
export type Product = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfProductDetails & {
  __typename?: 'Product';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
...
export type ProductDetails = AcfFieldGroup & AcfFieldGroupFields & ProductDetails_Fields & {
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;file&quot; Field Type added to the schema as part of the &quot;ProductDetails&quot; Field Group */
  pdf?: Maybe<AcfMediaItemConnectionEdge>;
};
...
export type ProductToProductCategoryConnectionEdge = Edge & ProductCategoryConnectionEdge & {
  ...
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The Yoast SEO Primary product_category */
  isPrimary?: Maybe<Scalars['Boolean']['output']>;
  /** The item at the end of the edge */
  node: ProductCategory;
};
...
/** Provides access to fields of the &quot;ProductDetails&quot; ACF Field Group via the &quot;productDetails&quot; field */
export type WithAcfProductDetails = {
  /** Fields of the ProductDetails ACF Field Group */
  productDetails?: Maybe<ProductDetails>;
};
